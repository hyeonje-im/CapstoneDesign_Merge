...
from random_mode import RandomModeManager #랜덤모드(식당모드)
...
random_manager = RandomModeManager(
    robot_controller=controller,
    agents_ref=agents,
    paths_ref=paths,
    get_grid_func=lambda: grid_array,
    get_tag_info_func=lambda: tag_info,
    path_to_commands_func=path_to_commands,
    get_initial_hd_func=get_initial_hd,
    home_positions=ROBOT_HOME_POSITIONS
)
controller.set_sequence_completion_callback(random_manager.on_sequence_complete)
