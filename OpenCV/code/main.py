...
controller.set_vision_system_provider(lambda: vision)  # VisionSystem 인스턴스를 리턴
...
def main():
    # 초기 설정
    global agents, paths, visualize, tag_info, grid_array, selected_robot_id, GOAL_ALIGN_MODE
    ...
    while True:
        ...
        #         if to_pause:
        #             controller.pause([str(r) for r in to_pause])      # 현재 명령 완료 후 정지(S)
